...
/** Base configuration for Vertex AI. */
export type VertexBaseConfig = Record<string, unknown>;
/** Union of parsed responses. */
export type ParsedResponseUnion = unknown;
...
export class OptimizeResponse {
  ...
  parsedResponse?: ParsedResponseUnion;
}
...
export declare interface OptimizeJobConfig {
  ...
  serviceAccountProjectNumber?: number | string;
  ...
  optimizerJobDisplayName?: string;
}
